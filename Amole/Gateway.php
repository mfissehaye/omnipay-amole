...
class Gateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\Omnipay\Amole\Message\PurchaseRequest', $parameters);
    }

    public function refund(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Amole\Message\RefundRequest', $parameters);
    }

    public function fetchSaleDetails(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Amole\Message\DetailSaleRequest', $parameters);
    }

    public function stopRecurring(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Amole\Message\StopRecurringRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\Amole\Message\CompletePurchaseRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\Amole\Message\NotificationRequest', $parameters);
    }
}
